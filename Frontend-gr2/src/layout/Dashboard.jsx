    ...
    return (
        <div className='md:flex md:min-h-screen'>
            ...
            <div className='md:w-1/5 bg-gray-800 px-5 py-4'>
                ...
                <h2 className='text-4xl font-black text-center text-slate-200'>Vet management</h2>
                ...
                <p className='text-slate-400 text-center my-4 text-sm'> <span className='bg-green-600 w-3 h-3 inline-block rounded-full'></span> Bienvenido - {auth?.rol === "paciente" ? auth?.propietario :auth?.nombre}</p>
            ...
            <div className='flex-1 flex flex-col justify-between h-screen bg-gray-100'>
                <div className='bg-gray-800 py-2 flex md:justify-end items-center gap-5 justify-center '>
                    <div className='text-md font-semibold text-slate-100 '>
                        Usuario - {
                            auth?.rol === "paciente" ? auth?.propietario :auth?.nombre 
                        }
                    </div>
                    <div>
